...
async def create_goal(
    goal: GoalSchema, user_id: str = Depends(get_current_user("userId"))
):
    try:
...
async def get_goal_by_id(
    goal_id: str, user_id: str = Depends(get_current_user("userId"))
):
    try:
...
async def update_goal(
    goal_id: str, goal: GoalSchema, user_id: str = Depends(get_current_user("userId"))
):
    try:
        goal.user_id = ObjectId(user_id)
